...
const seedDatabase = async () => {
	try {
		...
		// Primero, crea todas las canciones
		...
		// Crear álbumes con referencias a ID de canciones
		const albums = [
			{
				title: "Urban Nights",
		...
		// Insertar todos los álbumes
		const createdAlbums = await Album.insertMany(albums);

		// Actualizar las canciones con las referencias de sus álbumes
